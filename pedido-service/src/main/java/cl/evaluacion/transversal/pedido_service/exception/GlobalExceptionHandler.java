package cl.evaluacion.transversal.pedido_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> manejarNoEncontrado(PedidoNoEncontradoException ex, HttpServletRequest request){
