...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FAQNoEncontradaException.class)
    public ResponseEntity<ApiError> manejarNoEncontrado(FAQNoEncontradaException ex, HttpServletRequest request){
